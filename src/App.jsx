            ...
            onClick={async () => {
              try {
                const res = await fetch(
                  `http://localhost:3006/api/user/${username}`
                );
...
"
   ...
   Please don't"
      ...
      {/* <footer className="main-page-footer">
        <Link to="/test">
          <button className="main-page-footer-start pretty-button">
      ...
      <footer className="main-page-footer">
        <Link to="/test">
          <button
            ...
            onClick={(e) => {
              if (!username) {
                e.preventDefault(); // ⬅️ зупиняє перехід за посиланням
        ...
        {/* {openWindows.map((item, index) => (
          <button key={index} className="main-page-footer-random-button">
            {item}
          </button>
        ))} */}
      </footer>
